...
import de.ninafoss.generator.utils.MethodParameter;
...
public class CallbackModel {
	...
	private String resultTypeName(Method method) {
		...
		if (result.equals("de.ninafoss.presentation.workflow.ActivityResult") //
				|| result.equals("de.ninafoss.presentation.workflow.PermissionsResult") //
				|| result.equals("de.ninafoss.presentation.workflow.SerializableResult")) {
			return result;
		}
