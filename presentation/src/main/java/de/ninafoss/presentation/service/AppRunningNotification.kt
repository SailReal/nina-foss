...
class AppRunningNotification(private val context: Context, private val amountOfPictures: Int) {
	...
	private fun startTheActivity(): PendingIntent {
		val startTheActivity = Intent(context, MessageListActivity::class.java)
